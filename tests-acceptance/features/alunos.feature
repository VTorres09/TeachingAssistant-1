...
# Given I am at the students page                                                                       (OK)
# Given I can see a student with CPF "684" in the students list                                         (OK)
# Then I go to the metas page                                                                           (OK)
# And I write "8" and "9" on the grades of the student with CPF "684"                                   (OK)
# And I see that the student with CPF "684" has “Notificações de email” variable enabled                (OK)
